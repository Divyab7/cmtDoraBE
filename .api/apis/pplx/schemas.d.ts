    ...
    readonly body: {
        ...
        readonly properties: {
            readonly model: {
                ...
                readonly description: "The name of the model that will complete your prompt. Possible values include `sonar-deep-research`, `sonar-reasoning-pro`, `sonar-reasoning`, `sonar-pro`, `sonar`, and `r1-1776`.\n\nDefault: `sonar`";
                readonly enum: readonly ["sonar-deep-research", "sonar-reasoning-pro", "sonar-reasoning", "sonar-pro", "sonar", "r1-1776"];
